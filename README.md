...
For CPU and Kernel, /proc/cpuinfo and /proc/version. For GPUs, /proc/driver/nvidia/, or /sys/class/drm/. For uptime, /proc/uptime. For the terminal command was called on /proc/self/fd/0. For OS, /etc/os-release. For PC Name: 'hostnamectl'.
```rust
